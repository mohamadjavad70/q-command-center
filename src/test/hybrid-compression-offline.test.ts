...
describe("🧬 Phase 4: Neural Compression", () => {
  ...
  describe("Neural Compression Engine", () => {
    ...
    it("should calculate compression ratio", () => {
      compression.store("test1", "hello world hello world hello world", 0.5, 1);
      compression.store("test2", "goodbye world goodbye world goodbye", 0.5, 1);

      const stats = compression.getStats();

      // Ratio calculation checks
...
describe("📴 Phase 2: Offline-First AI", () => {
  ...
  describe("Rule Engine", () => {
    ...
    it("should match greeting patterns", () => {
      ...
      // Greeting should contain hour-based response or time reference
      expect(response).toMatch(/صبح|بعدازظهر|شب|من Q/i);
    });
...
describe("Performance & Integration", () => {
  ...
  it("should maintain reasonable compression ratio", () => {
    ...
    // Compression working (ratio should be reasonable)
    expect(stats.ratio).toBeGreaterThanOrEqual(0);
